...
export default {
    ...
    methods: {
        createTab() {
            ...
            let newTab = {
                // id: id, no id, this is auto generated by firestore
            ...
            this.$store.dispatch("addTabToFirestoreAndStore", newTab);

            // claer selected table in the dropdown to be ready for next time popup is opened
            this._selectedTableId = "";

            // close the popup on creation
